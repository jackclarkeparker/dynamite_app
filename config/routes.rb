Rails.application.routes.draw do
  ...
  get '/students/:student_id/contacts/:contact_id', to: 'student_contacts#edit_contact_relationship', as: :edit_contact_relationship
  ...
  get '/contacts/:contact_id/students/:student_id', to: 'student_contacts#edit_student_relationship', as: :edit_student_relationship
