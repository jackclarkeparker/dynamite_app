...
class LessonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lesson" do
    assert_difference("Lesson.count") do
      post lessons_url, params: { lesson: { capacity: @lesson.capacity, day: @lesson.day, standard_price: @lesson.standard_price, start_time: @lesson.start_time, tutor_id: @lesson.tutor_id, venue_id: @lesson.venue_id } }
    end
